// src/pages/Government/GovtBlockChainExplorer.jsx
...
export default function GovtBlockChainExplorer() {
  ...
  const fundStatusText = fundValid
    ...
    : "Fund Blockchain Tampered";

  const fundStatusDesc = fundValid
    ? "All fund release records are consistent and secured."
    : "Some fund blocks do not match their original hashes. Data may be changed.";
  ...
  const projectStatusText = projectValid
    ...
    : "Project Blockchain Tampered";

  const projectStatusDesc = projectValid
    ? "All project records are consistent and linked correctly."
    : "Some project blocks do not match their original hashes. Data may be changed.";
  ...
  return (
    <div className="min-h-screen w-full flex bg-slate-100 text-slate-900">
      {/* Government Sidebar */}
      <GovernmentSidebar active="blockchain-explorer" />
      ...
      <main className="flex-1 px-4 md:px-8 lg:px-10 py-8 lg:py-10 overflow-y-auto">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-semibold text-slate-900 flex items-center gap-3">
                <span className="p-3 rounded-xl bg-white shadow border border-slate-200">
                  <FaCubes className="text-indigo-700 w-6 h-6" />
                </span>
                Government Blockchain Explorer
              </h1>
              <p className="text-sm md:text-base text-slate-600 mt-2 max-w-2xl">
                Internal view for government officers to monitor{" "}
                <span className="font-semibold">fund releases</span> and{" "}
                <span className="font-semibold">projects</span> on separate
                blockchains. If one chain breaks, the other is not affected.
              </p>
            </div>
          ...
          <section className="bg-white border border-slate-200 rounded-2xl px-4 py-3 text-xs md:text-sm text-slate-700 shadow-sm flex items-start gap-2">
            <FaInfoCircle className="mt-0.5 text-indigo-700 w-4 h-4" />
            <p>
              The <span className="font-semibold">Fund Blockchain</span> stores
              government fund release transactions. The{" "}
              <span className="font-semibold">Project Blockchain</span> stores
              department project details. They are{" "}
              <span className="font-semibold">fully independent</span>, and each
          ...
          {activeTab === "fund" && (
            <>
              ...
              <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div className="w-full h-1.5 rounded-t-2xl bg-gradient-to-r from-emerald-500 to-sky-500" />
                  ...
                  <div className="bg-slate-50 rounded-xl px-4 py-3 text-sm flex flex-col gap-2 min-w-[230px] border border-slate-200">
                    <div className="flex items-center justify-between">
                      <span className="font-semibold flex items-center gap-2 text-slate-800">
                        <FaLink className="w-4 h-4 text-indigo-700" />
                        Total Blocks
                      </span>
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-600 mt-1">
                      ...
                      <span>
                        If any old fund record is edited, its hash changes and
                        the chain breaks.
                      </span>
                    </div>
                  </div>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-slate-900 mb-4 flex items-center gap-2">
                  <FaMoneyBillWave className="text-indigo-700 w-5 h-5" />
                ...
                {fundLoading ? (
                  ...
                  <div className="text-center text-slate-600 py-10 text-sm bg-white rounded-xl border border-dashed border-slate-300">
                    No fund blocks found yet. When funds are released, each
                    transaction will appear here.
                  </div>
                ) : (
                  <div className="w-full flex flex-row gap-6">
                    {/* legend (desktop) */}
                    <div className="hidden md:flex flex-col gap-3 pt-2 min-w-[160px] text-xs text-slate-600">
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-5 md:p-6">
                                ...
                                {/* Signature row */}
                                <div className="mt-3 bg-slate-50 rounded-xl p-3 border border-slate-200 text-[10px] md:text-[11px] text-slate-700">
                      ...
                      <table className="w-full border-collapse">
                        <tbody>
                          <tr className="border-b border-slate-200">
                            <td className="font-semibold py-2 pr-4 text-slate-700 w-40">
                              Block Number
                            </td>
            ...
            <>
                ...
                <div className="px-6 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="bg-slate-50 rounded-xl px-4 py-3 text-sm flex flex-col gap-2 min-w-[230px] border border-slate-200">
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-600 mt-1">
                      <FaInfoCircle className="w-3 h-3 text-slate-500" />
                      <span>
                        Any manual change in a project record will change its
                        hash and break the link.
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <section>
                ...
                {projectLoading ? (
                  ...
                  <div className="text-center text-slate-600 py-10 text-sm bg-white rounded-xl border border-dashed border-slate-300">
                    No project blocks found yet. When projects are added, blocks
                    will appear here.
                  </div>
                ) : (
